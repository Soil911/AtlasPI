...
(function() {
  ...
  window.I18N = {
    it: {
      ...
      // v6.50 / v6.90 A+: era chips (emoji rimossi in v6.90 editorial A+)
      era_bronze: 'Età del Bronzo',
      era_classical: 'Antichità',
      era_roman_peak: 'Roma imperiale',
      era_medieval: 'Medioevo',
      era_mongol: 'Mondo Mongolo',
      era_discovery: 'Età delle Scoperte',
      era_revolutions: 'Rivoluzioni',
      era_world_wars: 'Grande Guerra',
      era_today: 'Oggi',
      // v6.90 A+: era bands per timeline ticks + year-hero era label
      era_prehistoric: 'Preistoria',
      era_iron: 'Età del Ferro',
      era_early_medieval: 'Alto Medioevo',
      era_high_medieval: 'Basso Medioevo',
      era_early_modern: 'Prima età moderna',
      era_modern: 'Età contemporanea',
      // v6.90 A+: header + sidebar redesign keys
      app_subtitle_short: 'Geografia storica',
      era_section_label: 'Era',
      on_map_label: 'Sulla mappa',
      more_dropdown: 'Altro ▾',
      lang_label: 'Lingua',
      theme_label: 'Tema',
      overlay_label: 'Overlay',
      overlay_events: 'Mostra eventi storici',
      overlay_trade: 'Mostra rotte commerciali',
      year_hero_label: 'Anno corrente',
      life_timeline_label: 'Timeline di vita',
      capital_history_title: 'Cronologia capitali',
      // v6.90 A+: playback speed labels
      speed_fast: 'Veloce',
      ...
      surprise_btn: 'Sorprendimi',
      surprise_title: "Salta a un'entità storica casuale",
      surprise_error: 'Impossibile caricare un\'entità casuale — riprova.',
      otd_label: 'Accadde oggi',
      otd_in_year: 'nel',
      otd_open: 'Vai all\'evento →',
      otd_dismiss_aria: 'Chiudi il banner "Accadde oggi"',
    ...
    en: {
      ...
      // v6.90 A+: emoji removed for editorial A+ redesign
      ...
      era_world_wars: 'Great War',
      era_today: 'Today',
      // v6.90 A+: era bands per timeline ticks + year-hero era label
      era_prehistoric: 'Prehistoric',
      era_iron: 'Iron Age',
      era_early_medieval: 'Early Medieval',
      era_high_medieval: 'High Medieval',
      era_early_modern: 'Early Modern',
      era_modern: 'Modern',
      // v6.90 A+: header + sidebar redesign keys
      app_subtitle_short: 'Historical Geography',
      era_section_label: 'Era',
      on_map_label: 'On map',
      more_dropdown: 'More ▾',
      lang_label: 'Language',
      theme_label: 'Theme',
      overlay_label: 'Overlay',
      overlay_events: 'Show historical events',
      overlay_trade: 'Show trade routes',
      year_hero_label: 'Current year',
      life_timeline_label: 'Life timeline',
      capital_history_title: 'Capital history',
      // v6.90 A+: playback speed labels
      speed_fast: 'Fast',
      speed_normal: 'Normal',
      speed_slow: 'Slow',
      ...
      surprise_title: 'Jump to a random historical entity',
      surprise_error: 'Could not load a random entity — try again.',
      otd_label: 'On this day',
      otd_in_year: 'in',
      otd_open: 'View event →',
      otd_dismiss_aria: 'Dismiss the "On this day" banner',
