...
CSP_REPORT_ONLY = (
    ...
    # v6.99.115: stats.cra-srl.com = Matomo self-hosted (cookieless, siteId 2)
    # — sostituisce la dashboard analytics interna rimossa.
    "script-src 'self' 'unsafe-inline' https://unpkg.com https://stats.cra-srl.com; "
    ...
    "connect-src 'self' https://fonts.googleapis.com https://fonts.gstatic.com https://stats.cra-srl.com; "
