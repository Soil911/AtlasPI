...
app = FastAPI(
    ...
    openapi_tags=[
        ...
        {"name": "events", "description": "Historical events with date precision and entity links"},
        {"name": "chains", "description": "Succession chains (dynasty/state continuity) between entities"},
        {"name": "periods", "description": "Historical periods and epochs"},
        {"name": "cities-routes", "description": "Historical cities and trade routes"},
        {"name": "archaeological-sites", "description": "Archaeological and heritage sites"},
        {"name": "rulers", "description": "Historical rulers linked to entities"},
        {"name": "languages", "description": "Historical languages"},
        {"name": "search", "description": "Cross-resource and fuzzy search"},
        {"name": "export", "description": "GeoJSON, CSV and timeline export"},
        {"name": "snapshot", "description": "Single-call world snapshot for a given year"},
        {"name": "rendering", "description": "Server-side PNG map rendering"},
